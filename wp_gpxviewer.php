...
function show_gpxview($attr, $content = null)
{
	...
	if ($imageNumber > 0) {
		...
		$htmlstring  .= '<div id="fotorama" class="fotorama" data-auto="false" data-width="100%" data-fit="contain" data-ratio="1.5" data-nav="thumbs" data-allowfullscreen="native" data-keyboard="true" data-hash="true">';
	...
	if (strlen($gpxfile) > 3 && ($i > 0)) {
		$htmlstring  .= '<div id=boxmap>';
		$htmlstring  .= '<div id=map0 class="map gpxview:' . $gpxfile . ':OPENTOPO" style="width:100%;height:' . $mapheight . 'px"></div>';
		$htmlstring  .= '<div id="map0_profiles" style="width:100%;height:' . $chartheight . 'px"><div id="map0_hp" class="map" style="width:100%;height:' . $chartheight . 'px"></div></div>';
		$htmlstring  .= '<div id="map0_img">';
	} elseif ($imageNumber > 0){
		$htmlstring  .= '<div id=boxmap>';
		$htmlstring  .= '<div id=map0 class="gpxview::OPENTOPO" style="width:100%;height:' . $mapheight . 'px"></div>';
		$htmlstring  .= '<div id="map0_img">';
		$gpx_url = "";
	}
	...
	$htmlstring .= '<script> ';
	$htmlstring .= 'var g_numb_gpxfiles = "' . $i . '"; var Gpxpfad = "' . $gpx_url . '"; var Fullscreenbutton = false; var Arrowtrack = true; var Doclang="' . $lang . '"; var g_maprescale = '. $scale .'';
	$htmlstring .= '</script>';
